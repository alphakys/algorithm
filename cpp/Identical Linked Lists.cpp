...
{
    struct Node* comp1 = head1;
    struct Node* comp2 = head2;
    
    cout << (comp1!=nullptr && comp2!=nullptr);
    return true;
    int flag = comp1->data == comp2->data ? 1 : 0;
    ...
    if( comp1->data == comp2->data ){comp1 = comp1->next; comp2 = comp2->next;}
}